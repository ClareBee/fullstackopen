...
describe('favourite blogs', () => {
  test('when list has more than one blog equals the most likes', () => {
...
describe('mostBlog', () => {
  test('returns most popular author from list of blogs', () => {
...
describe('mostLikedAuthor', () => {
  test('returns author and total likes of most popular author', () => {
